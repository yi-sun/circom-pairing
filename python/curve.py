...
G1 = (FQ(0x17f1d3a73197d7942695638c4fa9ac0fc3688c4f9774b905a14e3a3f171bac586c55e83ff97a1aeffb3af00adb22c6bb
...
assert ((Y0**2 - Y1**2 - (4 + X0**3 - 3*X0*(X1**2))) % field_modulus == 0)
assert ((2*Y0*Y1 - 3*(X0**2)*X1 + (X1**3) - 4) % field_modulus == 0)


G2 = (FQ2([0x024aa2b2f08f0a91260805272dc51051c6e47ad4fa403b02b4510b647ae3d1770bac0326a805bbefd48056c8c121bdb8, 0x13e02b6052719f607dacd3a088274f65596bd0d09920b61ab5da61bbdc7f5049334cf11213945d57e5ac7d055d042b7e]),
      FQ2([0x0ce5d527727d6e118cc9cdc6da2e351aadfd9baa8cbdd3a76d429a695160d12c923ac9cc3baca289e193548608b82801,0x0606c4a02ea734cc32acd2b02bc28b99cb3e287e85a763af267492ab572e99ab3f370d275cec1da1aaa9075ff05f79be]))
...
def is_on_curve(pt, b):
    if is_inf(pt):
        return True
    x, y = pt
    if isinstance((y**2-x**3), FQ12):
      #print(x)
      #print(y)
      # print(y**2 - x**3)
      print(y**2-x**3)
      print(field_modulus)
      u = (y**2-x**3).coeffs[0].n
      v = (y**2-x**3).coeffs[6].n
    return y**2 - x**3 == b
