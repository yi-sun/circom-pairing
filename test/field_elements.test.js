...
describe("Fp12Add n = 2, k = 2", function () {
    ...
    var test_field_add_222 = function (x) {
        const [a0, a1, b0, b1, p, c0, c1] = x;
        var a0_array = bigint_to_array(2, 2, a0);
        var a1_array = bigint_to_array(2, 2, a1);
        var b0_array = bigint_to_array(2, 2, b0);
        var b1_array = bigint_to_array(2, 2, b1);
        var p_array = bigint_to_array(2, 2, p);
        var c0_array = bigint_to_array(2, 2, c0);
        var c1_array = bigint_to_array(2, 2, c1);
