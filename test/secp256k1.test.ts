...
describe("Secp256k1AddUnequal", function () {
    ...
    var test_secp256k1_add_instance = function (test_case: [bigint, bigint, bigint, bigint, bigint, bigint]) {
        ...
        var pub0x_array: bigint[] = bigint_to_array(52, 5, pub0x);
        var pub0y_array: bigint[] = bigint_to_array(52, 5, pub0y);
        var pub1x_array: bigint[] = bigint_to_array(52, 5, pub1x);
        var pub1y_array: bigint[] = bigint_to_array(52, 5, pub1y);
        var sumx_array: bigint[] = bigint_to_array(52, 5, sumx);
        var sumy_array: bigint[] = bigint_to_array(52, 5, sumy);
